...
import com.grupo4.repository.SubjectRepository;
...
class SubjectResourceIT {
    ...
    public static Subject createEntity(EntityManager em) {
        Subject subject = new Subject().subjectName(DEFAULT_SUBJECT_NAME).description(DEFAULT_DESCRIPTION);
        return subject;
    }
    ...
    public static Subject createUpdatedEntity(EntityManager em) {
        Subject subject = new Subject().subjectName(UPDATED_SUBJECT_NAME).description(UPDATED_DESCRIPTION);
        return subject;
    }
    ...
    void partialUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.subjectName(UPDATED_SUBJECT_NAME);
